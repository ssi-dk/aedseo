...
category. This is because the `very low` breakpoint is the disease-specific threshold, which must be surpassed with a five
week average observation count along with a significant positive growth rate.
