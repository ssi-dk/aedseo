...
Three datasets are created with same parameters and following combinations:
...
mem_obs_method_df |>
  ...
  ggplot2::guides(linetype = "none")
```
In the plots, observations below 100 are filtered out for better visualization.
