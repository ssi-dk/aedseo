...
The default of `n_peak` is `6` - corresponding with the `mem` defaults of using 30 observations across the latest `5` seasons.
...
Hence, with the default `decay_factor` = 0.8 the effective memory is `5` seasons.
